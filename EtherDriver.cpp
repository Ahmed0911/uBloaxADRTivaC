...
void EtherDriver::Init()
{
	...
	//lwIPInit(g_ui32SysClock, pucMACAddress, inet_addr("210.2.12.10"), inet_addr("0.0.255.255"), inet_addr("1.1.12.10"), IPADDR_USE_STATIC); 	// Set IP
